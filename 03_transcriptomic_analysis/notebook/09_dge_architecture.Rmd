...
library(Biostrings)
fasta<-readDNAStringSet("../../02_long_read_assemblies/analysis_and_temp_files/06_annotate_lecanoro/GTX0501_pred/annotate_results/Xanthoria_parietina_GTX0501.scaffolds.fa")
...
cat("## refGene\n",file='../analysis_and_temp_files/09_dge_architecture/reference.txt',append=T)
gff<-read.delim("../../02_long_read_assemblies/analysis_and_temp_files/06_annotate_lecanoro/GTX0501_pred/annotate_results/Xanthoria_parietina_GTX0501.gff3", header=F, comment.char="#") 
